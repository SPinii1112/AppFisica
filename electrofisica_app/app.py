...
# ---------------------------------------------------------
# BANCO EXTENDIDO Y AUDITADO DE 60 PREGUNTAS ÚNICAS
# ---------------------------------------------------------
PREGUNTAS_JUEGO = {
    "Fácil": [
        {"q": "1. ¿Qué ocurre electrostáticamente entre dos cargas del MISMO signo?", "opts": ["Se repelen mutuamente", "Se atraen mutuamente", "No interactúan", "Se anulan liberando calor"], "ans": 0, "exp": "Cargas de igual signo (+ con + o - con -) generan fuerzas repulsivas."},
        {"q": "2. ¿Cuál es la unidad del Sistema Internacional (SI) para la carga eléctrica?", "opts": ["Coulomb (C)", "Newton (N)", "Voltio (V)", "Joule (J)"], "ans": 0, "exp": "La unidad fundamental de carga eléctrica es el Coulomb (C)."},
        {"q": "3. ¿Qué establece el principio de CUANTIZACIÓN de la carga eléctrica?", "opts": ["Toda carga libre es un múltiplo entero de e (q = n·e)", "La carga puede tomar cualquier valor continuo", "La carga varía según la temperatura del cuerpo", "La carga depende únicamente del volumen"], "ans": 0, "exp": "La carga eléctrica existe en paquetes discretos múltiplos enteros de e = 1.602x10⁻¹⁹ C."},
        {"q": "4. Si la distancia entre dos cargas puntuales se DUPLICA (x2), ¿qué ocurre con la fuerza electrostática?", "opts": ["Se reduce a la cuarta parte (F / 4)", "Se reduce a la mitad (F / 2)", "Se duplica (F x 2)", "Se cuadruplica (F x 4)"], "ans": 0, "exp": "Según la Ley de Coulomb, la fuerza es inversamente proporcional al cuadrado de la distancia (1/r²)."},
        {"q": "5. ¿Cuál es la dirección radial de las líneas de campo eléctrico generadas por una carga POSITIVA?", "opts": ["Hacia afuera (salientes de la carga)", "Hacia adentro (entrantes a la carga)", "En espiral cerrada continua", "Paralelas al plano neutro"], "ans": 0, "exp": "Por convención, las líneas de campo eléctrico nacen en las cargas positivas y salen radialmente."},
        {"q": "6. ¿Qué partícula subatómica posee carga eléctrica de signo NEGATIVO?", "opts": ["Electrón", "Protón", "Neutrón", "Fotón"], "ans": 0, "exp": "El electrón lleva la carga elemental negativa (-1.602x10⁻¹⁹ C)."},
        {"q": "7. ¿Qué partícula subatómica posee carga eléctrica de signo POSITIVO?", "opts": ["Protón", "Electrón", "Neutrón", "Gluón"], "ans": 0, "exp": "El protón lleva la carga elemental positiva (+1.602x10⁻¹⁹ C)."},
        {"q": "8. ¿Qué tipo de fuerza ocurre entre dos cargas eléctricas de SIGNOS OPUESTOS?", "opts": ["Fuerza de atracción", "Fuerza de repulsión", "Fuerza nula", "Fuerza tangencial pura"], "ans": 0, "exp": "Cargas de distinto signo (+ y -) se atraen mutuamente."},
        {"q": "9. ¿Cómo se comparan los módulos de carga del protón y del electrón?", "opts": ["Son exactamente iguales en módulo (|e|)", "El protón es 1836 veces mayor", "El electrón es mayor en módulo", "Depende del medio material"], "ans": 0, "exp": "Ambos tienen exactamente el mismo valor absoluto (|e| ≈ 1.602x10⁻¹⁹ C), cambiando solo el signo."},
        {"q": "10. ¿Cuál es la notación estándar de la Constante Electrostática de Coulomb?", "opts": ["k_e", "G", "c", "h"], "ans": 0, "exp": "La constante electrostática se representa simbólicamente como k_e o simplemente k."},
        {"q": "11. ¿Qué instrumento clásico de laboratorio detecta la presencia de carga eléctrica por separación de láminas?", "opts": ["Electroscopio", "Voltímetro", "Amperímetro", "Manómetro"], "ans": 0, "exp": "El electroscopio utiliza el principio de repulsión entre láminas delgadas para detectar carga."},
        {"q": "12. Si el valor de una de las cargas se DUPLICA (x2) manteniendo la distancia constante, ¿qué le sucede a la fuerza?", "opts": ["Se duplica (F x 2)", "Se cuadruplica (F x 4)", "Se reduce a la mitad (F / 2)", "Permanece sin cambios"], "ans": 0, "exp": "La fuerza de Coulomb es directamente proporcional al producto de las cargas (F ∝ q1·q2)."},
        {"q": "13. ¿Puede existir una carga libre aislada cuyo valor sea exactamente 1.5 e?", "opts": ["No, porque la carga libre está estrictamente cuantizada en enteros (n ∈ ℤ)", "Sí, en cualquier material conductor", "Sí, si se calienta el objeto", "Solo en gases ionizados"], "ans": 0, "exp": "La cuantización prohíbe fracciones de la carga elemental en estado libre."},
        {"q": "14. ¿Qué establece la Ley de Conservación de la Carga Eléctrica en un sistema aislado?", "opts": ["La carga neta total se mantiene constante", "La carga siempre tiende a cero", "Las cargas negativas se convierten en positivas", "La carga total aumenta con el movimiento"], "ans": 0, "exp": "En todo proceso físico cerrado, la suma algebraica de las cargas no cambia."},
        {"q": "15. ¿Qué combinación de unidades en el SI equivale a 1 Voltio (V)?", "opts": ["1 Joule por Coulomb (1 J/C)", "1 Newton por Metro (1 N·m)", "1 Watt por Segundo (1 W/s)", "1 Coulomb por Segundo (1 C/s)"], "ans": 0, "exp": "Por definición, 1 Voltio es 1 Joule de energía por cada Coulomb de carga (1 V = 1 J/C)."},
        {"q": "16. ¿Qué significa que un cuerpo macroscópico esté en estado NEUTRO?", "opts": ["Posee igual cantidad de protones que de electrones", "No contiene electrones ni protones", "Solo contiene neutrones en su estructura", "Tiene energía potencial cero"], "ans": 0, "exp": "Estar neutro significa equilibrio numérico exacto entre cargas positivas y negativas."},
        {"q": "17. ¿Cómo se denomina al proceso de electrizar un objeto neutro acercándole otro cargado SIN tocarlo?", "opts": ["Inducción electrostática", "Conducción o contacto", "Fricción o rozamiento", "Polarización magnética"], "ans": 0, "exp": "La inducción produce redistribución de carga a distancia sin transferencia directa."},
        {"q": "18. ¿Cómo se denomina al proceso de electrizar dos objetos neutros frotándolos entre sí?", "opts": ["Fricción o rozamiento", "Inducción electrostática", "Conducción directa", "Radiación iónica"], "ans": 0, "exp": "Al frotar dos cuerpos de distinta afinidad electrónica, uno cede electrones al otro."},
        {"q": "19. ¿A cuánto equivale la unidad 1 microcoulomb (1 µC) en Coulombs?", "opts": ["10⁻⁶ C", "10⁻³ C", "10⁻⁹ C", "10⁻¹² C"], "ans": 0, "exp": "El prefijo micro (µ) representa una millonésima parte (10⁻⁶)."},
        {"q": "20. ¿El Campo Eléctrico es una magnitud de tipo Escalar o Vectorial?", "opts": ["Vectorial (posee magnitud, dirección y sentido)", "Escalar (solo requiere un número)", "Adimensional pura", "Tensor de segundo orden"], "ans": 0, "exp": "El campo eléctrico E se define con dirección y sentido en el espacio."}
    ],
    "Medio": [
        {"q": "1. ¿Cuál es el valor numérico aproximado de la Constante de Coulomb (k_e) en el vacío?", "opts": ["8.99 x 10⁹ N·m²/C²", "6.67 x 10⁻¹¹ N·m²/kg²", "3.00 x 10⁸ m/s", "1.60 x 10⁻¹⁹ C"], "ans": 0, "exp": "k_e ≈ 8.98755 x 10⁹ N·m²/C² en el Sistema Internacional."},
        {"q": "2. Si en un punto del espacio el campo eléctrico neto es CERO (E = 0), ¿cuál es la fuerza sobre una carga q situada allí?", "opts": ["Exactamente 0 Newtons", "Una fuerza infinita", "Fuerza igual a k_e·q", "Depende de la masa de la carga"], "ans": 0, "exp": "Dado que F = q·E, si E = 0 N/C la fuerza resultante es 0 N."},
        {"q": "3. ¿Cómo se define formalmente una Superficie Equipotencial?", "opts": ["Un lugar geométrico donde el potencial escalar V es constante en todos sus puntos", "Una superficie donde el campo E es nulo", "Una región de fuerza máxima", "Una zona sin cargas libres"], "ans": 0, "exp": "En cualquier punto de una superficie equipotencial, V toma el mismo valor numérico."},
        {"q": "4. Entre dos cargas puntuales de IGUAL signo y magnitud, ¿dónde se ubica el punto de campo cero (E = 0)?", "opts": ["En el punto medio exacto del segmento que las une", "En el infinito exclusivamente", "Sobre la superficie de la primera carga", "No existe punto de campo cero"], "ans": 0, "exp": "Por simetría, los dos vectores de campo de igual magnitud y sentidos opuestos se anulan en el centro."},
        {"q": "5. ¿Con qué ángulo cortan las líneas de Campo Eléctrico a las Superficies Equipotenciales?", "opts": ["Perpendicularmente a 90°", "Paralelamente a 0°", "A 45° exactos", "Depende del signo de la carga"], "ans": 0, "exp": "Las líneas de campo E siempre son ortogonales (90°) a las equipotenciales."},
        {"q": "6. ¿Cuál es el valor aproximado de la Permitividad del Vacío (ε_0)?", "opts": ["8.854 x 10⁻¹² C²/N·m²", "8.988 x 10⁹ N·m²/C²", "1.602 x 10⁻¹⁹ C", "9.806 m/s²"], "ans": 0, "exp": "ε_0 es la constante fundamental de permitividad electrostática del vacío."},
        {"q": "7. Si la distancia entre dos cargas se reduce a la MITAD (r / 2), ¿qué le sucede a la fuerza electrostática?", "opts": ["Se CUADRUPLICA (F x 4)", "Se duplica (F x 2)", "Se reduce a la mitad (F / 2)", "Se reduce a la cuarta parte"], "ans": 0, "exp": "F ∝ 1/(1/2)² = 4. Al reducir la distancia a la mitad, la fuerza aumenta 4 veces."},
        {"q": "8. ¿El Potencial Eléctrico (V) es una magnitud de tipo Escalar o Vectorial?", "opts": ["Escalar (se define mediante un valor numérico y su signo)", "Vectorial (requiere dirección y sentido)", "Matricial", "Adimensional"], "ans": 0, "exp": "El potencial eléctrico V mide energía por unidad de carga (J/C = V), siendo un escalar."},
        {"q": "9. ¿Qué relación matemática conecta la constante k_e con la permitividad ε_0?", "opts": ["k_e = 1 / (4 · π · ε_0)", "k_e = 4 · π · ε_0", "k_e = ε_0 / (4 · π)", "k_e = (4 · π) / ε_0"], "ans": 0, "exp": "k_e se define exactamente como 1 / (4π ε_0)."},
        {"q": "10. ¿Qué trabajo realiza la fuerza electrostática al desplazar una carga sobre una MISMA superficie equipotencial?", "opts": ["Cero Joules (0 J)", "Trabajo igual a q·V", "Trabajo máximo posible", "Depende del camino recorrido"], "ans": 0, "exp": "Como ΔV = 0 en la misma equipotencial, el trabajo es W = -q·ΔV = 0 J."},
        {"q": "11. ¿A cuánto equivale la unidad 1 nanocoulomb (1 nC) en Coulombs?", "opts": ["10⁻⁹ C", "10⁻⁶ C", "10⁻¹² C", "10⁻³ C"], "ans": 0, "exp": "El prefijo nano (n) representa una milmillonésima parte (10⁻⁹)."},
        {"q": "12. En equilibrio electrostático, ¿cuánto vale el campo eléctrico en el INTERIOR de un conductor sólido?", "opts": ["Cero (E = 0 N/C)", "Un valor uniforme infinito", "Depende del volumen total", "Igual al campo exterior"], "ans": 0, "exp": "Las cargas libres se desplazan a la superficie exterior hasta que el campo interno es 0 (Jaula de Faraday)."},
        {"q": "13. ¿Hacia dónde acelera espontáneamente una carga POSITIVA libre dentro de un campo eléctrico?", "opts": ["Hacia regiones de MENOR potencial eléctrico V", "Hacia regiones de mayor potencial eléctrico V", "En dirección perpendicular al campo", "Permanece en reposo"], "ans": 0, "exp": "Las cargas positivas sienten fuerza en la misma dirección de E, moviéndose de alto a bajo potencial."},
        {"q": "14. ¿Hacia dónde acelera espontáneamente una carga NEGATIVA libre dentro de un campo eléctrico?", "opts": ["Hacia regiones de MAYOR potencial eléctrico V", "Hacia regiones de menor potencial eléctrico V", "En trayectoria circular uniforme", "Hacia el infinito"], "ans": 0, "exp": "Las cargas negativas sienten fuerza opuesta a E, moviéndose de bajo a alto potencial."},
        {"q": "15. En la Ley de Coulomb vectorial, ¿cuál es la función del vector unitario r_hat?", "opts": ["Indicar únicamente la dirección y sentido de la línea de acción", "Multiplicar la magnitud por la distancia", "Convertir el resultado en escalar", "Representar la masa de la partícula"], "ans": 0, "exp": "El vector unitario r_hat tiene módulo 1 y otorga carácter vectorial a la fuerza."},
        {"q": "16. Para dos cargas del mismo signo donde |q1| < |q2|, ¿de cuál carga estará más cerca el punto E = 0?", "opts": ["De la carga de MENOR magnitud (|q1|)", "De la carga de mayor magnitud (|q2|)", "En el punto medio exacto", "Fuera de la línea que las une"], "ans": 0, "exp": "Para equilibrar intensidades de campo, el punto nulo debe estar más próximo a la carga más pequeña."},
        {"q": "17. ¿Cuál es la expresión para la aceleración (a) de una partícula cargada q con masa m en un campo E?", "opts": ["a = (q · E) / m", "a = (m · E) / q", "a = q · m · E", "a = E / (q · m)"], "ans": 0, "exp": "De F = m·a y F = q·E se despeja a = (q·E)/m."},
        {"q": "18. ¿Qué es un Dipolo Eléctrico puntual?", "opts": ["Un par de cargas de igual magnitud y signos opuestos separadas una distancia d", "Dos cargas positivas en contacto", "Una carga aislada en movimiento", "Tres cargas en triángulo"], "ans": 0, "exp": "Un dipolo consta de +q y -q separadas por una pequeña distancia d."},
        {"q": "19. ¿Cómo se define el módulo del momento dipolar eléctrico (p) para cargas +q y -q separadas d?", "opts": ["p = q · d", "p = q / d", "p = q² · d", "p = k_e · q / d²"], "ans": 0, "exp": "El momento dipolar se define como el producto p = q·d."},
        {"q": "20. ¿El potencial eléctrico V creado por una carga puntual POSITIVA aislada en el espacio es positivo o negativo?", "opts": ["Es positivo en todo el espacio (V > 0)", "Es negativo en todo el espacio (V < 0)", "Es cero en todos lados", "Cambia de signo con la distancia"], "ans": 0, "exp": "V = k_e·q/r. Como q > 0 y r > 0, el potencial es siempre positivo."}
    ],
    "Difícil": [
        {"q": "1. ¿En qué consiste formalmente el Principio de SUPERPOSICIÓN de Fuerzas Eléctricas?", "opts": ["La fuerza total sobre una carga es la SUMA VECTORIAL de las fuerzas individuales exercidas por las demás", "La fuerza total es la suma escalar de los módulos", "Las fuerzas se multiplican algebraicamente", "La carga de mayor magnitud anula a las demás"], "ans": 0, "exp": "El principio permite calcular F_total = ∑ F_i mediante adición vectorial de componentes."},
        {"q": "2. Entre dos cargas de SIGNOS OPUESTOS de distinta magnitud (|q1| < |q2|), ¿dónde se ubica el punto E = 0?", "opts": ["Fuera del segmento, del lado de la carga de MENOR magnitud (|q1|)", "En el punto medio del segmento", "Fuera del segmento, del lado de la carga mayor", "En ningún punto del espacio continuo"], "ans": 0, "exp": "Fuera del segmento las componentes tienen sentidos opuestos y se igualan cerca de la carga menor."},
        {"q": "3. ¿Qué ecuación conecta el trabajo electrostático conservativo (W) con la diferencia de potencial (ΔV)?", "opts": ["W = -q · ΔV", "W = q · E²", "W = k_e · q / r", "W = F · r²"], "ans": 0, "exp": "El trabajo realizado por el campo es W = -ΔU = -q·ΔV = q(V_inicial - V_final)."},
        {"q": "4. Tres cargas positivas iguales +q están en los vértices de un triángulo equilátero. ¿Cuánto vale E en el centro?", "opts": ["Cero (0 N/C)", "k_e·q / r²", "3 · k_e·q / r²", "Campo infinito"], "ans": 0, "exp": "Por simetría de 120°, la suma vectorial de los 3 campos centrípetos/centrífugos en el centro es 0 N/C."},
        {"q": "5. ¿Cómo se calcula la componente horizontal (Fx) de una fuerza F que forma un ángulo θ con el eje +X?", "opts": ["Fx = F · cos(θ)", "Fx = F · sen(θ)", "Fx = F / tan(θ)", "Fx = F · θ"], "ans": 0, "exp": "La proyección sobre el eje horizontal es Fx = F·cos(θ)."},
        {"q": "6. ¿Cómo se calcula la componente vertical (Fy) de una fuerza F que forma un ángulo θ con el eje +X?", "opts": ["Fy = F · sen(θ)", "Fy = F · cos(θ)", "Fy = F / cos(θ)", "Fy = F · θ²"], "ans": 0, "exp": "La proyección sobre el eje vertical es Fy = F·sen(θ)."},
        {"q": "7. Una carga negativa -q ingresa a una región con campo E uniforme vertical hacia abajo. ¿Hacia dónde acelera?", "opts": ["Hacia ARRIBA (en sentido contrario al campo E)", "Hacia abajo (en el mismo sentido del campo E)", "No sufre aceleración", "Hacia la derecha perpendicularmente"], "ans": 0, "exp": "Dado que F = -q·E para carga negativa, la fuerza y aceleración son opuestas a E."},
        {"q": "8. ¿Qué operador matemático relaciona el campo eléctrico E con el potencial V en una dimensión?", "opts": ["E = - dV / dx", "E = + dV / dx", "E = d²V / dx²", "E = V · x"], "ans": 0, "exp": "El campo eléctrico es el negativo de la derivada espacial (gradiente) del potencial: E = -dV/dx."},
        {"q": "9. Cuatro cargas iguales +q se fijan en los vértices de un cuadrado. ¿Cuánto vale E en el centro exacto?", "opts": ["Cero (0 N/C)", "4 · k_e·q / r²", "k_e·q / (2r²)", "Infinito"], "ans": 0, "exp": "Los 4 vectores diagonales opuestos se anulan por pares produciendo E = 0."},
        {"q": "10. Cuatro cargas iguales +q se fijan en las esquinas de un cuadrado de lado L. ¿El potencial V en el centro es cero?", "opts": ["No, V es positivo (V = 4 · k_e·q / r)", "Sí, V es cero por simetría", "V es negativo", "V es indeterminado"], "ans": 0, "exp": "El potencial es escalar. Al sumar 4 términos positivos V_i > 0, la suma es positiva."},
        {"q": "11. En el centro de un cuadrado de 4 cargas, ¿qué combinación de signos logra un potencial V = 0 Voltios?", "opts": ["Dos cargas positivas (+q) y dos negativas (-q)", "Las cuatro cargas positivas", "Tres cargas positivas y una negativa", "Ninguna combinación puede dar V = 0"], "ans": 0, "exp": "Al ser suma escalar, 2(+q) + 2(-q) se anulan dando V_total = 0 V."},
        {"q": "12. ¿Qué forma tiene la trayectoria de una carga lanzada perpendicularmente a un campo E uniforme?", "opts": ["Parabólica", "Circular perfecta", "Rectilínea uniforme", "Sinusoidal pura"], "ans": 0, "exp": "Posee velocidad constante en un eje y aceleración constante en el otro, generando una parábola."},
        {"q": "13. ¿Cuál es la expresión para la Energía Potencial Electrostática (U) entre dos cargas q1 y q2 a distancia r?", "opts": ["U = k_e · (q1 · q2) / r", "U = k_e · (q1 · q2) / r²", "U = k_e · (q1 + q2) / r", "U = q1 · q2 · r"], "ans": 0, "exp": "U = k_e · q1·q2 / r (nótese denominador r, no r²)."},
        {"q": "14. ¿Qué significado físico tiene que la Energía Potencial (U) de un sistema de dos cargas sea POSITIVA (U > 0)?", "opts": ["Las cargas son del mismo signo y el sistema es repulsivo", "Las cargas son de distinto signo y se atraen", "El sistema no requiere trabajo externo", "Las cargas están en equilibrio nulo"], "ans": 0, "exp": "U > 0 resulta de q1·q2 > 0 (igual signo), indicando repulsión y trabajo almacenado."},
        {"q": "15. ¿Qué significado físico tiene que la Energía Potencial (U) de un sistema sea NEGATIVA (U < 0)?", "opts": ["Las cargas son de signos opuestos y forman un sistema ligado atractivo", "Las cargas se repelen violentamente", "El sistema tiene masa cero", "La distancia r es negativa"], "ans": 0, "exp": "U < 0 ocurre con cargas de distinto signo, reflejando un estado atractivo ligado."},
        {"q": "16. En análisis dimensional, ¿cuáles son las dimensiones de la constante electrostática k_e en el SI?", "opts": ["[M L³ T⁻⁴ I⁻²]", "[M L T⁻²]", "[I T]", "[M L² T⁻³]"], "ans": 0, "exp": "Derivado de N·m²/C² = (kg·m/s²)·m² / (A·s)² = kg·m³·s⁻⁴·A⁻²."},
        {"q": "17. ¿Cómo decae la intensidad del campo eléctrico E de un dipolo puntual a distancias grandes r >> d?", "opts": ["Decae como 1 / r³", "Decae como 1 / r²", "Decae como 1 / r", "Se mantiene constante"], "ans": 0, "exp": "A distancias lejanas r >> d, el campo de un dipolo decae inversamente con el cubo de la distancia (1/r³)."},
        {"q": "18. ¿Cómo decae el potencial eléctrico V de un dipolo puntual a distancias grandes r >> d?", "opts": ["Decae como 1 / r²", "Decae como 1 / r³", "Decae como 1 / r", "Es independiente de r"], "ans": 0, "exp": "El potencial dipolar varía proporcionalmente a cos(θ)/r² a grandes distancias."},
        {"q": "19. Un electrón (carga e, masa m) acelera desde el reposo bajo una diferencia de potencial V. ¿Cuál es su velocidad v?", "opts": ["v = √(2 · e · V / m)", "v = e · V / m", "v = √(e · V · m)", "v = 2 · e · V · m"], "ans": 0, "exp": "De (1/2)m·v² = e·V se despeja v = √(2eV/m)."},
...
with tab4:
    ...
    with sub_tab_j:
        ...
        if st.session_state.escalon >= 8:
            st.balloons()
            st.success("🎉 ¡FELICITACIONES! ¡HAS LLEGADO AL ESCALÓN 8 Y GANADO EL DESAFÍO! 🏆")
            ...
            st.error("💥 ¡RESPUESTA INCORRECTA! CAÍSTE DE VUELTA AL ESCALÓN 0.")
            st.info(f"💡 **Explicación Didáctica**: {st.session_state.feedback_msg}")
            if st.button("🔄 Intentar de Nuevo (Nuevas 8 Preguntas)", type="primary"):
                st.session_state.escalon = 0
                st.session_state.game_over = False
                st.session_state.feedback_msg = ""
                st.session_state.shuffled_questions[st.session_state.juego_dif] = get_random_8_questions(st.session_state.juego_dif)
            ...
            if st.button("✅ Enviar Respuesta y Subir de Escalón", type="primary", use_container_width=True):
                ...
                if selected_idx == curr_q["ans"]:
                    ...
                    st.success(f"¡CORRECTO! 🌟 Subiste al Escalón {st.session_state.escalon} / 8")
                    st.info(f"💡 **Explicación**: {curr_q['exp']}")
                    st.rerun()
                else:
                    st.session_state.game_over = True
                    st.session_state.feedback_msg = curr_q["exp"]
                    st.rerun()
