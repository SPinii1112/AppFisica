...
# ---------------------------------------------------------
# BANCO EXTENDIDO Y AUDITADO DE PREGUNTAS (CON ÁNGULOS Y FORMATOS UNIFICADOS)
# ---------------------------------------------------------
PREGUNTAS_JUEGO = {
    "Fácil": [
        {"q": "¿Qué ocurre electrostáticamente entre dos cargas del MISMO signo?", "opts": ["Se repelen mutuamente con fuerzas de sentido opuesto", "Se atraen mutuamente dirigidas una hacia otra", "No ejercen ninguna fuerza de interacción", "Se anulan mutuamente liberando masa"], "ans": 0, "exp": "Cargas de igual signo (+ con + o - con -) generan fuerzas repulsivas dirigidas en la recta que las une."},
        {"q": "¿Cuál es la unidad del Sistema Internacional (SI) para la carga eléctrica?", "opts": ["Coulomb (C)", "Newton (N)", "Voltio (V)", "Joule (J)"], "ans": 0, "exp": "La unidad fundamental de carga eléctrica en el SI es el Coulomb (C)."},
        {"q": "¿Qué establece el principio de CUANTIZACIÓN de la carga eléctrica?", "opts": ["Toda carga libre es un múltiplo entero de e (q = n·e)", "La carga puede tomar cualquier valor decimal continuo", "La carga varía según la temperatura del cuerpo", "La carga depende únicamente del volumen del objeto"], "ans": 0, "exp": "La carga eléctrica existe en paquetes discretos múltiplos enteros de e = 1.602x10⁻¹⁹ C."},
        {"q": "Si la distancia r entre dos cargas puntuales se DUPLICA (x2), ¿qué ocurre con la fuerza electrostática F?", "opts": ["Se reduce a la cuarta parte (F / 4)", "Se reduce a la mitad (F / 2)", "Se duplica su valor (F x 2)", "Se cuadruplica su valor (F x 4)"], "ans": 0, "exp": "Según la Ley de Coulomb, la fuerza es inversamente proporcional al cuadrado de la distancia (1/r²)."},
        {"q": "¿Cuál es la dirección radial de las líneas de campo eléctrico generadas por una carga POSITIVA?", "opts": ["Hacia afuera (radial saliente desde la carga)", "Hacia adentro (radial entrante hacia la carga)", "En espiral cerrada continua en 2D", "Paralela al plano horizontal neutro"], "ans": 0, "exp": "Por convención, las líneas de campo eléctrico nacen en las cargas positivas y apuntan radialmente hacia afuera."},
        ...
        {"q": "¿Qué tipo de fuerza ocurre entre dos cargas eléctricas de SIGNOS OPUESTOS?", "opts": ["Fuerza de atracción dirigida hacia el centro común", "Fuerza de repulsión hacia el exterior", "Fuerza nula sin movimiento", "Fuerza tangencial ortogonal"], "ans": 0, "exp": "Cargas de distinto signo (+ y -) atraen sus posiciones mutuamente."},
        {"q": "¿Cómo se comparan los módulos de carga del protón y del electrón?", "opts": ["Son exactamente iguales en módulo (|e| ≈ 1.602x10⁻¹⁹ C)", "El protón es 1836 veces mayor en módulo", "El electrón es mayor en módulo que el protón", "Depende del medio dieléctrico"], "ans": 0, "exp": "Ambos tienen exactamente el mismo valor absoluto (|e|), difiriendo únicamente en el signo algebraico."},
        ...
        {"q": "¿Qué instrumento clásico de laboratorio detecta la presencia de carga eléctrica por separación de láminas metálicas?", "opts": ["Electroscopio", "Voltímetro", "Amperímetro", "Manómetro"], "ans": 0, "exp": "El electroscopio utiliza la repulsión entre dos láminas delgadas de oro/aluminio al cargarse."},
        {"q": "Si el valor de una de las cargas se DUPLICA (x2) manteniendo la distancia constante, ¿qué le sucede a la fuerza electrostática?", "opts": ["Se duplica (F x 2)", "Se cuadruplica (F x 4)", "Se reduce a la mitad (F / 2)", "Permanece constante"], "ans": 0, "exp": "La fuerza de Coulomb es directamente proporcional al producto de las cargas (F ∝ q1·q2)."},
        {"q": "¿Puede existir una carga libre aislada cuyo valor sea exactamente 1.5 e?", "opts": ["No, porque la carga libre está estrictamente cuantizada en enteros (n ∈ ℤ)", "Sí, en cualquier material conductor libre", "Sí, si se calienta la superficie", "Solo en gases ionizados a alta tensión"], "ans": 0, "exp": "La cuantización prohíbe fracciones de la carga elemental e en estado libre aislada."},
        {"q": "¿Qué establece la Ley de Conservación de la Carga Eléctrica en un sistema aislado?", "opts": ["La carga neta total se mantiene constante (∑ q_i = constante)", "La carga total siempre tiende a cero", "Las cargas negativas se convierten en positivas", "La carga total aumenta con la velocidad"], "ans": 0, "exp": "En todo proceso cerrado, la suma algebraica de todas las cargas iniciales e finales es idéntica."},
        {"q": "¿Qué combinación de unidades del SI equivale exactamente a 1 Voltio (V)?", "opts": ["1 Joule por Coulomb (1 J/C)", "1 Newton por Metro (1 N·m)", "1 Watt por Segundo (1 W/s)", "1 Coulomb por Segundo (1 C/s)"], "ans": 0, "exp": "Por definición de potencial escalar, 1 Voltio representa 1 Joule de energía por cada Coulomb de carga (1 V = 1 J/C)."},
        {"q": "¿Qué significa que un cuerpo macroscópico esté en estado NEUTRO?", "opts": ["Posee igual cantidad exacta de protones (+q) que de electrones (-q)", "No contiene electrones ni protones en sus átomos", "Solo contiene neutrones sin masa", "Tiene energía potencial eléctrica nula"], "ans": 0, "exp": "Estar neutro significa balance numérico exacto entre cargas positivas y negativas."},
        {"q": "¿Cómo se denomina al proceso de electrizar un objeto neutro acercándole otro cargado SIN tocarlo?", "opts": ["Inducción electrostática", "Conducción por contacto directo", "Fricción o rozamiento superficial", "Polarización magnética"], "ans": 0, "exp": "La inducción produce redistribución de carga a distancia sin transferencia física directa."},
        {"q": "¿Cómo se denomina al proceso de electrizar dos objetos neutros frotándolos entre sí?", "opts": ["Fricción o rozamiento", "Inducción electrostática", "Conducción directa", "Radiación ionizante"], "ans": 0, "exp": "Al frotar dos materiales de distinta afinidad electrónica, uno transfiere electrones al otro."},
        {"q": "¿A cuánto equivale la unidad 1 microcoulomb (1 µC) en Coulombs?", "opts": ["10⁻⁶ C (una millonésima de Coulomb)", "10⁻³ C (una milésima de Coulomb)", "10⁻⁹ C (una milmillonésima de Coulomb)", "10⁻¹² C"], "ans": 0, "exp": "El prefijo micro (µ) representa una millonésima parte (10⁻⁶ C)."},
        {"q": "¿El Campo Eléctrico es una magnitud de tipo Escalar o Vectorial?", "opts": ["Vectorial (posee magnitud, dirección y sentido espacial)", "Escalar (requiere solo un número numérico)", "Adimensional pura", "Tensor de segundo orden"], "ans": 0, "exp": "El campo eléctrico E se define con vector, dirección y sentido en el espacio 3D."}
    ],
    "Medio": [
        ...
        {"q": "Si en un punto del espacio el campo eléctrico neto es CERO (E = 0), ¿cuál es la fuerza sobre una carga q situada allí?", "opts": ["Exactamente 0 Newtons (F = 0 N)", "Una fuerza infinita descontrolada", "Fuerza igual al producto k_e·q", "Depende de la masa inercial m de la carga"], "ans": 0, "exp": "Dado que F = q·E, si E = 0 N/C la fuerza electrostática resultante es exactamente 0 N."},
        {"q": "¿Cómo se define formalmente una Superficie Equipotencial?", "opts": ["Lugar geométrico espacial donde el potencial V tiene el mismo valor en todos sus puntos", "Superficie donde el campo eléctrico E es exactamente nulo", "Región de fuerza atractiva máxima", "Zona libre de líneas de campo"], "ans": 0, "exp": "En cualquier punto sobre una superficie equipotencial, el valor del potencial escalar V es constante."},
        {"q": "Entre dos cargas puntuales de IGUAL signo y magnitud, ¿dónde se ubica el punto de campo cero (E = 0)?", "opts": ["En el punto medio exacto del segmento que une ambas cargas", "En el infinito exclusivamente", "Sobre la superficie de la primera carga", "No existe ningún punto con campo cero"], "ans": 0, "exp": "Por simetría, los vectores de campo de igual magnitud y sentidos opuestos se anulan en el centro."},
        {"q": "¿Con qué ángulo geométrico interceptan las líneas de Campo Eléctrico a las Superficies Equipotenciales?", "opts": ["Perpendicularmente a 90° (ángulo recto ortogonal)", "Paralelamente a 0° (tangente a la superficie)", "A 45° de inclinación oblicua", "Varía según el signo algebraico de la carga"], "ans": 0, "exp": "Las líneas de campo E siempre cruzan ortogonalmente (a 90°) a las equipotenciales."},
        {"q": "¿Cuál es el valor numérico aproximado de la Permitividad del Vacío (ε_0)?", "opts": ["8.854 x 10⁻¹² C²/N·m²", "8.988 x 10⁹ N·m²/C²", "1.602 x 10⁻¹⁹ C", "9.806 m/s²"], "ans": 0, "exp": "ε_0 es la constante fundamental de permitividad electrostática del vacío libre."},
        {"q": "Si la distancia r entre dos cargas se reduce a la MITAD (r / 2), ¿qué le sucede a la fuerza electrostática F?", "opts": ["Se CUADRUPLICA su valor (F x 4)", "Se duplica su valor (F x 2)", "Se reduce a la mitad (F / 2)", "Se reduce a la cuarta parte"], "ans": 0, "exp": "F ∝ 1/(1/2)² = 4. Al reducir la distancia a la mitad, la fuerza aumenta 4 veces."},
        {"q": "¿El Potencial Eléctrico (V) es una magnitud de tipo Escalar o Vectorial?", "opts": ["Escalar (se define mediante un valor numérico escalar y su signo)", "Vectorial (requiere dirección y sentido vectorial)", "Matricial 3x3", "Adimensional"], "ans": 0, "exp": "El potencial eléctrico V mide energía potencial por unidad de carga (J/C = V), siendo un escalar."},
        {"q": "¿Qué relación matemática conecta la constante de Coulomb k_e con la permitividad ε_0?", "opts": ["k_e = 1 / (4 · π · ε_0)", "k_e = 4 · π · ε_0", "k_e = ε_0 / (4 · π)", "k_e = (4 · π) / ε_0"], "ans": 0, "exp": "k_e se define exactamente como 1 / (4π ε_0)."},
        {"q": "¿Qué trabajo electrostático W realiza el campo al desplazar una carga sobre una MISMA superficie equipotencial?", "opts": ["Cero Joules (0 J)", "Trabajo igual al producto q·V", "Trabajo máximo posible", "Depende del camino sinuoso recorrido"], "ans": 0, "exp": "Como ΔV = 0 en la misma equipotencial, el trabajo es W = -q·ΔV = 0 J."},
        {"q": "¿A cuánto equivale la unidad 1 nanocoulomb (1 nC) en Coulombs?", "opts": ["10⁻⁹ C (una milmillonésima de Coulomb)", "10⁻⁶ C", "10⁻¹² C", "10⁻³ C"], "ans": 0, "exp": "El prefijo nano (n) representa una milmillonésima parte (10⁻⁹ C)."},
        {"q": "En equilibrio electrostático, ¿cuánto vale el campo eléctrico en el INTERIOR de un conductor sólido?", "opts": ["Cero (E = 0 N/C)", "Un valor uniforme infinito", "Depende del volumen geométrico total", "Igual al campo eléctrico exterior"], "ans": 0, "exp": "Las cargas libres se desplazan a la superficie exterior dejando un campo nulo adentro (Jaula de Faraday)."},
        {"q": "¿Hacia dónde acelera espontáneamente una carga POSITIVA libre dentro de un campo eléctrico E?", "opts": ["Hacia regiones de MENOR potencial eléctrico V", "Hacia regiones de mayor potencial eléctrico V", "En dirección perpendicular a las líneas de campo", "Permanece en reposo inercial"], "ans": 0, "exp": "Las cargas positivas sienten fuerza en la misma dirección de E, moviéndose de alto a bajo potencial."},
        {"q": "¿Hacia dónde acelera espontáneamente una carga NEGATIVA libre dentro de un campo eléctrico E?", "opts": ["Hacia regiones de MAYOR potencial eléctrico V", "Hacia regiones de menor potencial eléctrico V", "En trayectoria circular uniforme", "Hacia el infinito continuo"], "ans": 0, "exp": "Las cargas negativas sienten fuerza opuesta a E, moviéndose de bajo a alto potencial."},
        {"q": "En la Ley de Coulomb vectorial, ¿cuál es la función del vector unitario r_hat?", "opts": ["Indicar únicamente la dirección y sentido de la línea de acción", "Multiplicar la magnitud escalar por la distancia", "Convertir el resultado en un escalar puro", "Representar la masa inercial de la partícula"], "ans": 0, "exp": "El vector unitario r_hat tiene módulo 1 y otorga carácter vectorial a la fuerza electrostática."},
        {"q": "Para dos cargas del mismo signo donde |q1| < |q2|, ¿de cuál carga estará más cerca el punto E = 0?", "opts": ["De la carga de MENOR magnitud (|q1|)", "De la carga de mayor magnitud (|q2|)", "En el punto medio exacto", "Fuera de la línea que une las cargas"], "ans": 0, "exp": "Para equilibrar intensidades de campo, el punto nulo debe estar más próximo a la carga más pequeña."},
        {"q": "¿Cuál es la expresión para la aceleración (a) de una partícula cargada q con masa m en un campo E?", "opts": ["a = (q · E) / m", "a = (m · E) / q", "a = q · m · E", "a = E / (q · m)"], "ans": 0, "exp": "De F = m·a y F = q·E se despeja la aceleración a = (q·E)/m."},
        {"q": "¿Qué es un Dipolo Eléctrico puntual?", "opts": ["Un par de cargas de igual magnitud y signos opuestos (+q y -q) separadas una distancia d", "Dos cargas positivas en contacto directo", "Una carga aislada en movimiento uniforme", "Tres cargas formando un triángulo"], "ans": 0, "exp": "Un dipolo consta de dos cargas +q y -q separadas por una pequeña distancia d."},
        {"q": "¿Cómo se define el módulo del momento dipolar eléctrico (p) para cargas +q y -q separadas una distancia d?", "opts": ["p = q · d", "p = q / d", "p = q² · d", "p = k_e · q / d²"], "ans": 0, "exp": "El momento dipolar escalar se define como el producto p = q·d."},
        {"q": "¿El potencial eléctrico V creado por una carga puntual POSITIVA aislada en el espacio es positivo o negativo?", "opts": ["Es positivo en todo el espacio (V > 0)", "Es negativo en todo el espacio (V < 0)", "Es exactamente cero en todos lados", "Cambia de signo con la distancia r"], "ans": 0, "exp": "V = k_e·q/r. Como q > 0 y r > 0, el potencial es estrictamente positivo en todo el espacio."}
    ],
    "Difícil": [
        ...
        {"q": "Si una fuerza vector F forma un ángulo θ respecto al eje horizontal positivo (+X), ¿cuál es la fórmula de su componente horizontal Fx?", "opts": ["Fx = F · cos(θ) (proyección sobre el eje horizontal +X)", "Fx = F · sen(θ) (proyección sobre el eje vertical)", "Fx = F / tan(θ)", "Fx = F · θ"], "ans": 0, "exp": "La proyección sobre el eje horizontal relativo a un ángulo θ con +X es Fx = F·cos(θ)."},
        {"q": "Si una fuerza vector F forma un ángulo θ respecto al eje horizontal positivo (+X), ¿cuál es la fórmula de su componente vertical Fy?", "opts": ["Fy = F · sen(θ) (proyección sobre el eje vertical +Y)", "Fy = F · cos(θ) (proyección sobre el eje horizontal)", "Fy = F / cos(θ)", "Fy = F · θ²"], "ans": 0, "exp": "La proyección sobre el eje vertical relativo a un ángulo θ con +X es Fy = F·sen(θ)."},
        ...
        {"q": "¿Cómo varía el potencial eléctrico V de un dipolo con el ángulo θ (respecto al eje dipolar) a distancias lejanas r >> d?", "opts": ["Varía proporcionalmente a cos(θ) / r²", "Varía proporcionalmente a sen(θ) / r³", "Varía como 1 / r (independiente del ángulo θ)", "Es constante en todas las direcciones"], "ans": 0, "exp": "El potencial dipolar varía proporcionalmente a cos(θ)/r² a grandes distancias."},
...
with tab3:
    ...
    with col_e2_p:
        ...
        <div class="info-box">
            ...
            <b>Ángulo del Vector E:</b> {E_angle:.1f}° <i>(respecto al eje positivo +X en sentido antihorario)</i>
        </div>
        """, unsafe_allow_html=True)
